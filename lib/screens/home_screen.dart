  ...
  void sendMessage() {
    ...
    if (text.isNotEmpty) {
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => ChatScreen(query: text),
        ),
      );
          ...
          children: [
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              gradient: LinearGradient(
                                colors: [
                                  AppColors
                                      .deepGreenAccentColor,
                                  AppColors
                                      .lightGreenAccentColor
                                ],
                                begin:
                                    Alignment.topLeft,
                                end: Alignment
            ...
            SizedBox(
              ...
              child: ListView.builder(
                itemCount:
                    AppConstant.defaultQues.length,
                scrollDirection:
                    Axis.horizontal,
